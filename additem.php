...
<body>
  ...
  <section class="home-section">
      ...
      <form action="dbh.php" method="POST" class="addform">
          <label>Item Name:</label>
          <input type="text" placeholder="Enter Food Item" name="item_name"><br>
          <label>Item Price:</label>
          <input type="number" placeholder="Enter Price" name="price" id="sec"><br>
