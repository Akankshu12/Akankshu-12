...
<html lang="en" dir="ltr">
  <head>
    ...
    <style>
        ...
        section .users_table th, section .users_table td{
            padding: 35px 30px;
        }
        button{
            color: white;
  ...
  <section class="home-section">
      ...
      <table class="users_table">
        ...
        <?php
          ...
          $sql = "SELECT id, item_name, quantity, name, mobile_no, pay_id, action FROM penorders";
          $result = $conn->query($sql);
          if($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
                echo "<tr><td>". $row["id"]. "</td><td>". $row["item_name"]. "</td><td>". $row["quantity"]. "</td><td>". $row["name"]. "</td><td>". $row["mobile_no"]. "</td><td>". $row["pay_id"]. "<td><button>Accept</button></td>". "</td><tr>";
            }
                echo "</table>";
            }
            else{
